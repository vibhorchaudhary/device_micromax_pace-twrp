...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --dt device/micromax/pace/dt.img
TARGET_PREBUILT_KERNEL := device/micromax/pace/kernel
...
# Recovery
TARGET_RECOVERY_FSTAB := device/micromax/pace/twrp.fstab
